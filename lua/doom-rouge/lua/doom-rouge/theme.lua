...
theme.set_highlights = function()
  ...
  hl(0, "DiagnosticWarn", { fg = c.bg, bg = c.orange })
  hl(0, "DiagnosticUnderlineError", { fg = c.fg, bg = 'NONE', underline=true, sp=c.red })
  hl(0, "DiagnosticUnderlineWarn", { fg = c.fg, bg = 'NONE', underline=true, sp=c.orange })
  hl(0, "DiagnosticUnderlineInfo", { fg = c.fg, bg = 'NONE', underline=true, sp=c.cyan })
  hl(0, "DiagnosticUnderlineHint", { fg = c.fg, bg = 'NONE', underline=true, sp=c.cyan })
  hl(0, "DiagnosticUnderlineOk", { fg = c.fg, bg = 'NONE', underline=true, sp=c.green })
  hl(0, "DiagnosticError", { fg = c.bg, bg = c.red })
  hl(0, "DiagnosticInfo", { fg = c.bg, bg = c.blue })
  hl(0, "DiagnosticHint", { fg = c.bg, bg = c.cyan })
  hl(0, "DiagnosticOk", { fg = c.bg, bg = c.green })
